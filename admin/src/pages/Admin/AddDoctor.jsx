...
const AddDoctor = () => {
  ...
  const onSubmitHandler = async (event) => {
    ...
    try {
      ...
      // ready for to store the database
      const formData = new FormData()  // built in js object, it specially use for handling doc. or files so we need this
      ...
      formData.append('address', JSON.stringify({line1:address1, line2:address2}))  // because FormData accept only string or blobs (like files), not raw objects
      ...
      if(data.success){
        ...
        // when successfully added the reset the exiting information
        setDocImg(false)
        setName('')
        setPassword('')
        setEmail('')
