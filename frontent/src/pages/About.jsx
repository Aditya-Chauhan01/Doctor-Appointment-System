...
const About = () => {
  return (
    <div>
      ...
      <div className='text-xl my-4 text-center mb-10'>
        <p>WHY <span>CHOOSE US</span></p>
      </div>

      <div className='flex flex-col md:flex-row mb-15'>
        <div className='border px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary hover:text-white transition-all text-gray-600'>
          <b>Efficiency:</b>
