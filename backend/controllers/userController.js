...
const registerUser = async (req, res) => {
    try {
        ...
        /*when we wrape the plain obj with model then It follows the schema you defined (userSchema). It automatically gets an _id. It has methods like .save(), .validate(), .remove(), etc. */
...
const bookAppointment = async (req, res) => {
    try {
        ...
        let slots_booked = docData.slots_booked     // it gives an object where sloteDate is array key which includes multiple slotstime
...
const paymentRazorpay = async (req, res) => {
    try {
        ...
        const options = {
            amount: appointmentData.amount * 100, // for removing the decimal value(i.e. '.00')
